...
public class YoloModel {
    ...
    private static final String[] CLASSES = {"Sign Language"};
    ...
    public void detectSignlanguage(Mat image, double detectionthreshold) {
    ...
    public void detectSignlanguage(INDArray inputimage, Mat outputimage, double detectionthreshold) {
        Yolo2OutputLayer yout = (Yolo2OutputLayer) NETWORK.getOutputLayer(0);
